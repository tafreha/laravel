...
<body>
    <div class="container mt-5">
        <form action="<?php echo url('user/store');?>"  method="post" enctype="multipart/form-data">
          <h3 class="text-center mb-5">ADD ARTICLE</h3>
            @csrf
...
<body>
    <div class="container mt-5">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control"  id="exampleInputName" aria-describedby="" name="date" placeholder="Enter title"  width="100px" height="200px" value="<?php echo old('title');?>">

            </div>
            <div class="custom-file">
                <label >image</label>
                <input type="file" class="form-control"  id="exampleInputName" aria-describedby="" name="image" placeholder="Enter title"  width="100px" height="200px" value="<?php echo old('title');?>">
